...
def generalize_segments(levelling_segments_input, source_points_input, points_classification_output, sorted_segments_output) -> None:
...
if __name__ == '__main__':
    ...
    generalize_segments(levelling_segments_input, source_points_input, points_classification_output, sorted_segments_output)
