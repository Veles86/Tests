function [ E,N ] = IGD12toIG12( phi, lambda)

% example:
%   [ E,N ] = IGD12toIG12( 31.9419401833333, 34.6813911277778)

[X,Y,Z] = GG2XYZ(phi,lambda,zeros(size(phi,1),1),'WGS84');

[X_GRS80,Y_GRS80,Z_GRS80] = WGS84toGRS80(X,Y,Z);

[phi_GRS80, lambda_GRS80] = XYZ2GG(X_GRS80,Y_GRS80,Z_GRS80,'GRS80');

[E,N] = GRS80toITM(phi_GRS80, lambda_GRS80);
...
function [ X_GRS80,Y_GRS80,Z_GRS80 ] = WGS84toGRS80( X,Y,Z )
...
X_GRS80 = dX+(scale*X+Y*RZ-Z*RY);
Y_GRS80 = dY+(-X*RZ+scale*Y+Z*RX);
Z_GRS80 = dZ+(X*RY-Y*RX+scale*Z);
